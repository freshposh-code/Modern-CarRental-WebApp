...
export function AnimatedModalDemo({data}: ItemsData) {
  return (
    <div className="flex items-center justify-center">
      <Modal>
        <ModalTrigger className="bg-blue-700 rounded-full text-white flex justify-center group/modal-btn">
          <span className="group-hover/modal-btn:translate-x-40 text-center transition duration-500 md:text-base text-[10px]">
            Rent Now
          </span>
