...
const Footer = () => {
  ...
  return (
    <footer className='bg-zinc-900 dark:bg-zinc-800 md:px-16 px-6 py-10 text-zinc-300 mt-16 md:text-base text-xs'>
      <div className="flex justify-between lg:flex-row flex-col">
          <div className="flex flex-col item-center z-[1000]">
